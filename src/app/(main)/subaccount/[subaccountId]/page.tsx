    ...
    <BlurPage>
      <div
        className={clsx('relative h-full', {
          'overflow-hidden': !subaccountDetails.connectAccountId,
        })}
      >
        ...
        <div className="flex flex-col gap-4 pb-6">
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <PipelineValue subaccountId={params.subaccountId} currency={currency} />
          </div>
          ...
          <div className="flex gap-4 flex-col xl:!flex-row">
            ...
            <Card className="relative xl:w-1/2">
              <CardHeader>
                    ...
                    {totalClosedSessions
                      ? totalClosedSessions.map((session) => (
                          <TableRow key={session.id}>
                            ...
                            <TableCell>
                              <Badge className="bg-teal-600 dark:text-white">Paid</Badge>
                            </TableCell>
