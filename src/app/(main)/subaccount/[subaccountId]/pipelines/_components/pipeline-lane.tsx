  ...
  return (
    <Draggable draggableId={laneDetails.id.toString()} index={index} key={laneDetails.id}>
      {(provided, snapshot) => {
        ...
        return (
          <div {...provided.draggableProps} ref={provided.innerRef} className="h-full m-1">
            <AlertDialog>
              <DropdownMenu>
                <div className="bg-muted h-[700px] w-[300px] px-4 relative rounded-lg overflow-visible flex-shrink-0">
                  <div
                    {...provided.dragHandleProps}
                    className=" h-14 backdrop-blur-lg dark:bg-background/40 bg-muted absolute top-0 left-0 right-0 z-10 "
                  >
