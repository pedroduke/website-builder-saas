  ...
  return (
    ...
    >
      {!agencyDetails.connectAccountId && (
        <div className="absolute -top-10 left-0 right-0 bottom-0 z-30 flex items-center justify-center backdrop-blur-md bg-background/50 h-screen">
          <Card>
            <CardHeader>
        ...
        <div className="flex gap-4 flex-col xl:!flex-row">
          ...
          <Card className="flex-1 relative">
            <CardHeader>
              ...
              <CardTitle className="tex-4xl">{subaccounts.length}</CardTitle>
            </CardHeader>
            <CardContent className="text-sm text-muted-foreground">
