...
const initialEditorState: EditorState['editor'] = {
  ...
  selectedElement: defaultEmptyElement,
  device: 'Desktop',
  previewMode: false,
  liveMode: false,
  funnelPageId: '',
...
const updateAnElement = (editorArray: EditorElement[], action: EditorAction): EditorElement[] => {
  if (action.type !== 'UPDATE_ELEMENT')
    throw new Error('You sent the wrong action type to the Update Element editor State');
  ...
  switch (action.type) {
    ...
    case 'CHANGE_CLICKED_ELEMENT':
      const clickedState = {
        ...
        editor: {
          ...state.editor,
          selectedElement: action.payload.elementDetails || defaultEmptyElement,
        },
        history: {
          ...state.history,
          history: [
