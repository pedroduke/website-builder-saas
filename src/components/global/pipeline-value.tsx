...
const PipelineValue = ({ subaccountId, currency }: Props) => {
    ...
    <Card className="relative w-full xl:w-[350px]">
      <CardHeader>
        ...
        <CardTitle className="text-4xl">
          {pipelineClosedValue ? `${currency} ${pipelineClosedValue.toFixed(2)}` : `$0.00`}
        </CardTitle>
        <CardDescription className="text-xs text-muted-foreground">
          ...
          <Progress color="green" value={pipelineRate} className="h-2 mt-1" />
        </CardDescription>
      </CardHeader>
